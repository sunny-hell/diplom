...
VideoProcessor::VideoProcessor(const char *videoFile, const char *gtFile, const char *resultFile, const char *gtType, double devs[]) {
...
void VideoProcessor::processVideo(){
	...
	ParticleFilter *pf = new ParticleFilter(800, 50, 60, templateHist, devs, width, height, nFrames);
